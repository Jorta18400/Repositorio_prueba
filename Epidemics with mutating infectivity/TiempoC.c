...
// donde se calcula el tiempo característico de la red en función de p //                                                                     
/////////////////////////////////////////////////////////////////////////
...
#define lambda 1 //Probabilidad de infección, en el caso del cálculo del tiempo característico es 1
...
int main(void)
{
    ...
    double p; //Probabilidad de recableado
    FILE *ftiempo; //Fichero donde se guarda el tiempo que se tardó en infectar todo para cada red

    p=0.000; //Valor inicial de p
